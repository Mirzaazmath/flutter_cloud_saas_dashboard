...
class SmallScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool ismall= Responsivness.isSmallScreen(context);
    return Scaffold(
      drawer: Container(
        width: 250,
        child: SideBar(),
                ...
                children: [
                  ...
                  Expanded(
                    child: GridView.count(
                      ...
                      crossAxisSpacing: 10,
                      mainAxisSpacing: 10,
                      childAspectRatio:ismall?1: 1/1.3,
                      // childAspectRatio: 1/1,
                      crossAxisCount:ismall?2: 4,
                      children:dashboardlist.map((e) => Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(e.title,style: const  TextStyle(color: Colors.white70,fontSize:16,fontWeight: FontWeight.bold),),
